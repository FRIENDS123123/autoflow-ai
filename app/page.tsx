          ...
          <section className="px-4 pb-20">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={() => { setStatus("idle"); setNodes([]); setPrompt(""); }}
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-sm font-semibold transition-all duration-200 shadow-lg shadow-purple-900/40">
                    <Play size={13} />
                    Deploy Automation
                  </button>
                </div>
